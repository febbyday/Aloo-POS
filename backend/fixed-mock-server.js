...
const mockShops = [
  ...
  },
  {
    ...
    operatingHours: {
      ...
      saturday: { open: true, openTime: "09:00", closeTime: "22:00", breakStart: null, breakEnd: null },
      sunday: { open: true, openTime: "11:00", closeTime: "19:00", breakStart: null, breakEnd: null }
    },
    settings: {
...
app.get('/api/v1/shops', (req, res) => {
  ...
  console.log('Sending response with', mockShops.length, 'shops');
