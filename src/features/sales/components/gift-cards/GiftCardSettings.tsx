...
import { GiftCardSettings as GiftCardSettingsType } from '../../types/gift-cards';
...
interface GiftCardSettingsProps {
  settings: GiftCardSettingsType;
  onSave: (settings: GiftCardSettingsType) => Promise<void>;
}
...
export function GiftCardSettings({ settings, onSave }: GiftCardSettingsProps) {
  ...
  const handleSubmit = async (data: FormValues) => {
    ...
    try {
      await onSave(data as GiftCardSettingsType);
      toast({
