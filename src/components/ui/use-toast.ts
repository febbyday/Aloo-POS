  ...
  try {
    ...
    if (
      ...
      try {
        ...
        // If stringify fails, provide a helpful message
    ...
    // Fallback if there's an error in the toast itself
    ...
    dispatch({
      ...
      toast: {
        ...
        variant: "destructive",
        title: "Toast Error",
        description: "An error occurred while displaying this notification",
        open: true,
        onOpenChange: (open) => {
          if (!open) dismiss()
        },
