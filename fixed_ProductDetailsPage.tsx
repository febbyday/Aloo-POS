                      ...
                      {product.isTemporary && (
                        <div className="mb-4 p-3 border border-dashed border-yellow-300 bg-yellow-50 rounded-md">
                          ...
                          <ul className="text-xs text-yellow-700 space-y-1">
                            ...
                            {!product.barcode && <li>• Barcode</li>}
                            {!product.brandId && <li>• Brand</li>}
                            {!product.categoryId && <li>• Category</li>}
                            {!product.supplier?.name && <li>• Supplier</li>}
                            {!product.locations?.some(loc => loc.stock > 0) && <li>• Stock levels</li>}
                            {!product.images?.length && <li>• Product images</li>}
                          </ul>
                        </div>
                      )}
